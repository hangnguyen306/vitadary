...
imgSVG();// Go to top
gotoTop();//waypointEl();
slider();sHomeProduct();sHomeNews();searchBox();stick();sProduct();$('.lazy').lazy();fixHeight();function init(){// waypointEl();
// // Base
// ui();
// // Image SVG
// imgSVG();
...
// sliderPartner();
// sliderEvent();
$(window).on('debouncedresize',function(event){})}$(window).resize(function(){sProduct()});// $('body').imagesLoaded( function() {
//     init();
